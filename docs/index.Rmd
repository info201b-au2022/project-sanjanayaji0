...
**Sanjana Somayajula, Oswaldo Jimenez, Ian Chiu**
...
"Dynamic" paragraph. Write a summary paragraph that includes information calculated by your summary information function. (See chapter 18 in the book.) Table. (a) Render your table. (b) In a short paragraph beneath your table, describe pertinent observations found in it Three charts. (a) Render each of your charts. (b) In a short paragraph beneath each chart, describe the purpose of the chart and pertinent observations.
...
This graph shows the correlation between how much electricity is being produced or how developed a nation's electricity grid is and how that relates to the overall HDI of the area. We can see the graph doesn't really show a correlation between the development of a national power grid and the overall HDI of the area.
...
This chart tells us what form of energy generation yields the most energy output from the least waste energy. From this graph we can see hydro power delivers the best results with 90% output.
...
This graph highlights countries on a scale of their HDI and what source of energy holds the largest share in their country. Each dot on the chart represents a country and the higher the HDI on the graph, the better a country is doing both socially and economically. The importance of this graph is to highlight the trend of which sources of energy provide the best HDI. Energy is vital in a country's development and through analyzing its source, one can make conclusions on the impact the source has on a country's development.
