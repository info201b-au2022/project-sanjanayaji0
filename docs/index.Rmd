---
title: "Energy: World Peace"
author: "Sanjana Somayajula, Oswaldo Jimenez, Ian Chiu"
date: "11/09/2022"
...
### Expected Implications and Limitations: 

The benefactors of the data we collected more than often are the researchers themselves, who consist mostly of students committing to internships. Evidently, once all the data points have been collected, they will be cited. Along with the sources we cited earlier, others will likely be added. Limitations include data about certain countries being unavailable. We are also working with such large data sets that some factors such as democratic index will be excluded, which could affect the calculated data.

# Data Analysis Report

## Dynamic Paragraph

We aggregated the following data from each country:

-   Human Development Index: a statistic composite index of life expectancy, education, and income.

-   Energy Grid: primary energy consumption in kilowatt hours, which is the unit of energy used to express the amount of produced energy, electricity and heat. It is separated by fossil fuel electricity per capita, nuclear electricity per capita, and renewable electricity per capita for each country.

-   Economics: GDP (Gross Domestic Product) growth in % for each country.

-   Energy Consumption: primary energy consumption per capita in kWh/person which is kilowatt hours.

-   Energy Emissions: CO2 emissions in metric tons per capita.

We calculated five values from the data to summarize our statistics from each data set. Our first value is the **global mean of human development index from 2021.** Our calculated value was ***0.7181244***. Human Development value is measured on a scale from 0 to 1, and in our data we are correlating HDI to general quality of life. The average of this value measures the average for the world. This statistic is important as it pertains to a key element of our research question about quality of life. Our next summary value was the **change in average GDP (Gross Domestic Product) in each country in the past 30 years**. We are using GDP to represent a nation's economic standing which is also a part of our question regarding quality of life. Our calculated value was ***3.637778%***. This means that in the past 30 years, GDP growth has increased by about 3.7%. This value is important for our purposes because we will compare this value along with the HDI value with each nation's energy grid, in order to answer our central question of how a nation's energy consumption, emissions, and source of energy effects general quality of life. Our third value is **the change in energy consumption for the past 30 years.** Our calculated value was ***2102.827*** kilowatt hours per person. This value shows us that there has been a significant increase in global energy consumption. This value is important to us because it helps us examine our questions regarding how human development has improved, as an increase in energy consumption indicates an increase in development. Our fourth value was the **change in CO2 emissions per country in the last 30 years.** Our calculated value was ***-0.3878026.*** This indicates that there has been a decrease in CO2 emissions, which goes along with our background research in which we learned emissions from factories have significantly reduced, though there have been increased use of cars which has increased the overall carbon footprint. This value is pertinent to our question of how energy emissions and consumption is affected by quality of life. Our final value we calculated was **the number of kilowatt hours for the country which currenly uses the most renewable energy.** Our calculated value was ***56769.74*** kilowatt hours, and the country was Iceland. This value is important to our data because countries which use more renewable energy are more environmentally sustainable, and have a more developed energy grid. By comparing this value with our quality of life factors, we are able to answer our research questions.

[**Chart 1: Electricity Generation v. Human Development Index**]{.underline}

```{r echo=FALSE}
chart1
```

This graph shows the correlation between how much electricity is being produced or how developed a nation's electricity grid is and how that relates to the overall HDI of the area. Each dot on the graph represents a country. The actual country doesn't matter in this graph, as we are only looking to find a correlation between HDI, and Electricity generated. We can see the graph doesn't really show a correlation between the development of a national power grid and the overall HDI of the area. This provides an answer for our first research question of: *How can a developed national energy grid impact the quality of living of its citizens?* Since we are using HDI as a measure of quality of life, and this chart shows that there isn't really a correlation between the amount of energy being produced, we can conclude that a developed energy grid doesn't really impact the quality of life for citizens.

[**Chart 2: Energy Sources and their Efficiency**]{.underline}

```{r echo=FALSE}
chart2
```

This chart tells us what form of energy generation yields the most energy output from the least waste energy. From this graph we can see hydro power delivers the best results with 90% output. This graph addresses our second research question of: *Which form of energy promises the most grid efficiency?* This graph shows us that hydro power promises the most grid efficiency. This conclusion also has real world implications, as knowledge that hydro power is the most efficient can help countries in developing their energy grid, as energy efficiency is a huge global concern. It also answers the question of which energy source countries should implement for maximum energy efficiency.

[**Chart 3: Largest Share vs. HDI 2021**]{.underline}

```{r echo = FALSE, plotly = TRUE}
chart3
```

This graph highlights countries on a scale of their HDI and what source of energy holds the largest share in their country. Each dot on the chart represents a country and the higher the HDI on the graph, the better a country is doing both socially and economically. By hovering the cursor over each dot, one can see the country name as well as GDP and largest share of energy used. You can also isolate a country's data by double clicking the country from the legend. The importance of this graph is to highlight the trend of which sources of energy provide the best HDI. Energy is vital in a country's development and through analyzing its source, one can make conclusions on the impact the source has on a country's development. Essentially, this graph answers our third central question of: *Which form of energy consistently delivers improvements in HDI? And what can nations learn from our findings?* From this chart, we can conclude that countries with higher HDI have the largest share of coal and carbon as their sources of energy.
