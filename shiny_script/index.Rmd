...
# How a Developed National Energy Grid Impacts the Quality of Life
...
|---------------|---------------|---------------|---------------|---------------|
| HDI                | 191                 | 8                | [HDI](https://hdr.undp.org/sites/default/files/2021-22_HDR/HDR21-22_Statistical_Annex_HDI_Table.xlsx)                                                                                                                                      | Addresses general development of each country                                          |
| Energy Grid        | 191                 | 32               | [Energy Grid](https://ourworldindata.org/grapher/electricity-prod-source-stacked)                                                                                                                                                          | Breakdown of sources of energy - coal, oil, gas, nuclear, and renewables               |
| Economics          | 191                 | 33               | [Economics](https://api.worldbank.org/v2/en/indicator/NY.GDP.MKTP.KD.ZG?downloadformat=csv)                                                                                                                                                | GDP per country (Gross Domestic Product), organized per country per year starting 1990 |
| Energy Consumption | 191                 | 4                | [Energy Consump](https://ourworldindata.org/explorers/energy?tab=table&facet=none&country=USA~GBR~CHN~OWID_WRL~IND~BRA~ZAF&hideControls=false&Total+or+Breakdown=Total&Energy+or+Electricity=Primary+energy&Metric=Per+capita+consumption) | Per capita energy consumption per country from 1990-2021                               |
| Energy Emissions   | 191                 | 6                | [Energy Emissions](https://api.worldbank.org/v2/en/indicator/EN.ATM.CO2E.PC?downloadformat=csv)                                                                                                                                            | Energy dependency, efficiency, and carbon dioxide emissions from 1990-2015             |
...
-   **World Bank Group:** Non profit dedicated to presenting information and reducing poverty.

### Findings

Our main finding is that there is not an apparent correlation between the development of a national power grid and the overall HDI of a country. HDI is our measured quality of life, and our first interactive chart showed us that a developed energy grid doesn't really impact the quality of life for citizens. We also found that hydro power promises the most grid efficiency with 90% output. This answers our question of which energy source countries should implement for maximum energy efficiency. Finally, we found that countries with a higher HDI have their largest share of energy in coal and carbon. We found that countries like Switzerland and Australia center themselves around carbon and coal energy. More specifically, we found that while carbon has the maximum HDI, countries whose largest energy source is coal have a consistently high HDI, though not the maximum.

### Discussion

Nations are consistently striving to get the best quality of life. Our exploration of which energy factors effect that are wholly relevent to the real world as they can help countries choose how to develop their energy grid to improve quality of life for all citizens. This is a factor that effects the entire world. Our conclusion about the source of energy that countries with the highest HDI use the most is important because energy is vital in a country's development and through analyzing its source, one can make conclusions on the impact the source has on a country's development. Our exploration of which form of energy promises the most grid efficiency has real world implications because knowledge that hydro power is the most efficient can help countries in developing their energy grid, as energy efficiency is a huge global concern. It also answers the question of which energy source countries should implement for maximum energy efficiency.

### Conclusion

Issues of energy and the quality of life will forever be relevant to our world, especially as environmental concerns continue to grow. Thus, our data is incredibly relevant to the real world, and will continue to be relevant as the population increases, and energy remains a major political, social, and global concern. Data like this calls for countries to be vigilant of what is best for their citizens, and which energies prove to be the most efficient. This kind of data also enables countries to learn from each other, which is a profoundly powerful tool.
